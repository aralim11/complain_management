        ...
        <table class="table table-bordered">
            ...
            @foreach($ticket as $tickets)
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <button class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#editModal{{ $tickets->id }}">Replay</button>&nbsp;&nbsp;
                            @include('client.createticket.updateTicketModal')
                        </div>
                    </td>
                </tr>
            @endforeach
