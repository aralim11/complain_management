...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('supervisor.profile.update', Auth::id()) }}">
                @csrf
                @method('PUT')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="department" type="text" class="form-control" name="department" value="{{ $profile->user_group_for_admin->name }}" autofocus readonly>
                    </div>
                </div>
